...
import bcrypt from 'bcryptjs';const mesureSchema = new Schema({
...
}, { timestamps: true });// Schéma pour le profil des utilisateurs
...
}, { _id: false });  // Important: _id: false pour éviter un ID distinct// Schéma pour les utilisateurs
...
}, { timestamps: true });// Hook pour hacher le mot de passe avant de sauvegarder
