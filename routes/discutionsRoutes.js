...
router.post('/create', discussionsValidationRules(), ValidationMiddleware.validate, DiscussionsController.createOrUpdateDiscussion.bind(DiscussionsController));

// Route pour récupérer toutes les discussions d'un utilisateur spécifique
router.get('/:userId', DiscussionsController.getDiscussions.bind(DiscussionsController));

// Route pour récupérer une discussion spécifique par son ID
router.get('/discussion/:id', DiscussionsController.getDiscussionById.bind(DiscussionsController));
